...
ExptTHdata = np.load(f'{NPY_Path}/Info_Vals.npy')
ExptTHstd  = np.load(f'{NPY_Path}/Info_Vars.npy')
ExptTHup_bound = ExptTHdata + np.sqrt(ExptTHstd)
ExptTHlo_bound = ExptTHdata - np.sqrt(ExptTHstd)

# Then the MDIP
NPY_Path = "NPYs/MAQRO8/MDIP/Data"
...
MDIPTHdata = np.load(f'{NPY_Path}/Info_Vals.npy')
MDIPTHstd  = np.load(f'{NPY_Path}/Info_Vars.npy')
