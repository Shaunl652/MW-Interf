# ==============================================================================
# Contains the Mie scattering functions that the code uses
# These are all taken from the PyMieScatt library with some minor modifications
# ==============================================================================
...
#  http://pymiescatt.readthedocs.io/en/latest/forward.html#MieQ
  ...
  if x==0:
    ...
    return RayleighMieQ(m, wavelength, diameter, nMedium, asDict, asCrossSection)
  elif x>0.05:
...
# ================================================================
#   CHANGES
# Set nmax = None in the definition so that I can specify nmax if I want for testing purposes
# ================================================================
  mx = m*x
  if nmax == None:
      nmax = np.round(2+x+4*(x**(1/3)))
